    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                  ...
                                  <li>
                                      <a href="<?php echo base_url('kandidat/profile'); ?>"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                                  </li>
                              	<?php	}else{ ?>
                                  <li>
                                      <a href="<?php echo base_url('panitia/profile'); ?>"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                                  </li>
                              <?php		} ?>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url('auth/logout'); ?>"><i class="demo-pli-unlock icon-lg icon-fw"></i> Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        <div class="pad-btm">
                                            <img class="img-circle img-md" src="<?php echo base_url('assets');?>/upload/images/foto_profil/<?= $profile['photo']; ?>" alt="Profile Picture">
                                        </div>
                                        <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            <span class="pull-right dropdown-toggle">
                                                <i class="dropdown-caret"></i>
                                            </span>
                                            <p class="mnp-name"><?= $profile['username']; ?></p>
                                            <span class="mnp-desc"><?= $profile['email']; ?></span>
                                        </a>
                                    </div>
                                    <div id="profile-nav" class="collapse list-group bg-trans">
                                        <a href="<?php echo base_url('admin/profile'); ?>" class="list-group-item">
        ...
        <footer id="footer">
            ...
            <div class="hide-fixed pull-right pad-rgt">
                Tamplate By <strong>Nifty</strong> Modify By Vebritok_blo. - User Aktif <b><?= $profile['username']; ?></b>
            </div>
