...
<div id="page-content">
  ...
  <div class="row pad-btm">
      ...
      <?php echo form_open_multipart('panitia/saksi/CariData'); ?>
      <div class="col-sm-6 toolbar-right text-right">
          ...
          <a class="btn btn-default" style="margin-bottom:15px" href="<?php echo base_url('panitia/saksi'); ?>"><i class="ti-reload"></i></a>
      </div>
  </div>
  <?php echo form_close(); ?>
...
<!-- Start Modal Edit -->
<?php echo form_open_multipart('panitia/Saksi/Edit'); ?>
              ...
              <div class="modal-dialog ">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                            ...
                            <a class="btn btn-danger btn-rounded" href="<?php echo base_url('panitia/Saksi/Hapus/'. $saksi->id) ?>">Hapus Saksi</a>
                        </div>
                </div>
              </div>
            </div>
...
<!--Non Aktifkan User-->
 <?php echo form_open_multipart('panitia/Saksi/vnonaktif'); ?>
 ...
 <!-- Aktifkan User-->
  <?php echo form_open_multipart('panitia/Saksi/vaktif'); ?>
...
<!-- Start Modal Tambah -->
<?php echo form_open_multipart('panitia/Saksi/Tambah'); ?>
                           ...
                           <div class="form-group col-md-6 required ">
                              ...
                              <div class="form-group col-md-6 required ">
                               ...
                               <div class="form-group col-md-6 required ">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-addon selectpicker"><i class="ti-save-alt"></i></div>
                                      <select class="form-control selectpicker" id="kategori_saksi" name="kategori_saksi">
                                ...
                                <div class="form-group col-md-6 required ">
                                       ...
                                       <div class="input-group">
                                         <div class="input-group-addon selectpicker"><i class="ti-book"></i></div>
                                       <select class="form-control selectpicker" id="saksi_pemilihan" name="saksi_pemilihan">
