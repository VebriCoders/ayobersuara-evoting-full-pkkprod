...
<div id="page-content">
 ...
 <div class="row pad-btm">
  ...
  <?php echo form_open_multipart('panitia/kandidat/CariData'); ?>
     <div class="col-sm-6 toolbar-right text-right">
         ...
         <a class="btn btn-default" style="margin-bottom:15px" href="<?php echo base_url('panitia/kandidat'); ?>"><i class="ti-reload"></i></a>
     </div>
 </div>
 <?php echo form_close(); ?>
 <!---------------------------------->
                     ...
                     <div class="modal-dialog ">
                       <div class="modal-content">
                         ...
                         <div class="modal-footer">
                                   ...
                                   <a class="btn btn-danger btn-rounded" href="<?php echo base_url('panitia/Kandidat/Hapus/'. $kandidat->id) ?>">Hapus Kandidat</a>
                               </div>
                       </div>
                     </div>
                   </div>
...
<!--===================================================-->
<?php echo form_open_multipart('panitia/Kandidat/Edit'); ?>
...
<!--===================================================-->
<?php echo form_open_multipart('panitia/Kandidat/Tambah'); ?>
