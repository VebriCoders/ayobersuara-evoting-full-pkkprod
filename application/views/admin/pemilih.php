...
<ol class="breadcrumb text-center">
  ...
  <li class="active">Daftar Pemilih</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
...
<div id="page-content">
  ...
  <div class="row pad-btm">
      <div class="col-sm-6 toolbar-left">
          ...
          <a href="<?= base_url('Cetak/cetakPemilih/') ?>" class="btn btn-default"  target="__blank"><i class="demo-pli-printer"></i></a>
      </div>
      ...
      <div class="col-sm-6 toolbar-right text-right">
          ...
          <div class="form-group">
            <?php if($this->uri->segment(3) != 'CariData'){ ?>
               <input type="text" placeholder="<?= $site['s_nomor_pemilihan']; ?> " id="demo-inline-inputmail" name="nomor_pemilih" class="form-control">
           <?php } ?>
  					        ...
  					        <table id="demo-foo-filteringkategoriveb" class="table table-bordered table-hover toggle-circle" data-page-size="15">
  					            <thead>
  					                <tr>
  					                    ...
  					                    <th>Nama Pemilih</th>
                                <th>Email Pemilih</th>
  					                    <th>Nomor Pemilihan (<?= $site['s_nomor_pemilihan']; ?>)</th>
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-6 required ">
                 ...
                 <div class="form-group col-md-6 required ">
                        ...
                        <div class="input-group">
                          <div class="input-group-addon"><i class="ti-user"></i></div>
                          <input class="form-control" value="<?php echo $pemilih->nomor_pemilih; ?>" placeholder="<?= $site['s_nomor_pemilihan']; ?>" required="required" name="nomor_pemilih" type="text" id="nomor_pemilih">
                        </div>
                  </div>
                  <div class="form-group col-md-6 required ">
              ...
              <div class="modal-dialog ">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                            ...
                            <p>Apakah anda yakin ingin menghapus Pemilih <b> <?php echo $pemilih->nama_pemilih; ?></b>Nomor Pemilihan <?= $site['s_nomor_pemilihan']; ?> (<?php echo $pemilih->nomor_pemilih; ?>), Dengan Status Memilih <b><?php if($pemilih->status_memilih=='1'){echo "Sudah Memilih";}else{echo "Belum Memilih";} ?> </b> ?</p>
                  </div>
                                         ...
                                         <div class="modal-header">
                                          ...
                                          <!-- Contact Widget -->
                    					            ...
                    					            <div class="panel pos-rel">
                                                      ...
                                                      <p class="text-lg-center"><i class="ti-key"> </i> Nomor Pemilihan (<?= $site['s_nomor_pemilihan']; ?>) : <?php echo $pemilih->nomor_pemilih ?></p>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
              <input type="hidden" name="id" value="<?php echo $pemilih->id; ?>" />
                ...
                <input class="form-control" value="<?php echo $pemilih->nomor_pemilih; ?>" placeholder="Nama Pemilih" required="required" name="nama_pemilih" type="hidden" id="nama_pemilih">
                <div class="modal-footer">
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group col-md-6 required ">
                               ...
                               <div class="form-group col-md-6 required ">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                        <input class="form-control" placeholder="<?= $site['s_nomor_pemilihan']; ?>" required="required" name="nomor_pemilih" type="number" id="nomor_pemilih">
                                      </div>
                                </div>
                                <div class="form-group col-md-6 required ">
                                       <label for="" class="control-label">No Telepon/Whatsapp</label><span class="red">*</span>
