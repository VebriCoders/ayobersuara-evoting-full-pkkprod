...
<div id="page-title" class="pad-all text-center">
    <h3>Data Kategori Kandidat - Admin</h3>
</div>
<!--Breadcrumb-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<ol class="breadcrumb text-center">
  ...
  <li class="active">Kategori Kandidat</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
...
<div id="page-content">
  ...
  <div class="row pad-btm">
      <div class="col-sm-6 toolbar-left" style="margin-bottom:15px">
          ...
          <a class="btn btn-default" href="<?php echo base_url('admin/kategori_kandidat'); ?>"><i class="ti-reload"></i></a>
      </div>
  </div>
<?= $this->session->flashdata('flash'); ?>
              <div class="panel">
  					    <div class="panel-heading">
  					        <h3 class="panel-title">Kategori Kandidat</h3>
  					    </div>
  					    ...
  					    <div class="panel-body">
  					        <table id="demo-foo-filteringkategoriveb" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                ...
                                <th data-hide="phone, tablet">Menu</th>
  					            ...
  					            <tbody>
                          <?php
                          foreach( $tampilKatKandidat->result() as $kat ){ ?>
  					                <tr>
                ...
                <div class="modal-dialog ">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                              ...
                              <a class="btn btn-danger btn-rounded" href="<?php echo base_url('admin/kategori_kandidat/Hapus/'. $kat->id) ?>">Hapus Kategori</a>
                          </div>
                  </div>
                </div>
              </div>
...
<!-- Start Modal Edit -->
<?php echo form_open_multipart('admin/kategori_kandidat/Edit'); ?>
...
<div class="modal-content">
   ...
   <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal"><i class="pci-cross pci-circle"></i></button>
       <h4 class="modal-title">Edit Kategori Kandidat</h4>
   </div>
...
<!-- Start Modal Tambah -->
<?php echo form_open_multipart('admin/kategori_kandidat/Tambah'); ?>
...
<div class="modal-content">
   ...
   <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal"><i class="pci-cross pci-circle"></i></button>
       <h4 class="modal-title">Tambah Kategori Kandidat</h4>
   </div>
