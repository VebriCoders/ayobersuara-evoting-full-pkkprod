<div id="page-head">
  ...
  <div class="pad-all text-center">
    <h3>Profile - Admin (<?= $profile['username']; ?>).</h3>
      ...
      foreach ($tampilProfil->result() as $user) { ?>
        ...
        <div class="panel">
          ...
          <div class="panel-body text-center bg-purple">
            ...
            <p class="text-sm">Super Admin Aplikasi <b><?= $site['nama_website']; ?></b></p>
          </div>
...
<!-- Start Modal Edit -->
<?php echo form_open_multipart('admin/Profile/ubahProfile'); ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-6 required ">
          ...
          <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-user-o"></i></div>
            <input class="form-control" value="<?php echo $user->email ?>" placeholder="Email" required="required" name="email" type="email" id="email">
          </div>
        </div>
        <div class="form-group col-md-6 required ">
...
<!-- Start Modal Pswd -->
<?php echo form_open_multipart('admin/Profile/Pswd'); ?>
      ...
      <div class="modal-body">
        ...
        <div class="form-group col-md-12 required ">
          ...
          <div class="input-group">
            ...
            <input class="form-control frmpswd" placeholder="Pasword Baru" required minlength="5" name="password" type="password" id="password">
          </div>
        </div>
