...
<div id="page-title" class="pad-all text-center">
    <h3>Data Kategori Saksi - Admin</h3>
</div>
<!--Breadcrumb-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<ol class="breadcrumb text-center">
  ...
  <li class="active">Kategori Saksi</li>
</ol>
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--End breadcrumb-->
</div>
...
<div id="page-content">
  ...
  <div class="row pad-btm">
      <div class="col-sm-6 toolbar-left" style="margin-bottom:15px">
          ...
          <a class="btn btn-default" href="<?php echo base_url('admin/kategori_saksi'); ?>"><i class="ti-reload"></i></a>
      </div>
  </div>
<?= $this->session->flashdata('flash'); ?>
              <div class="panel">
  					    <div class="panel-heading">
  					        <h3 class="panel-title">Kategori Saksi</h3>
  					    </div>
  					    ...
  					    <div class="panel-body">
  					        <table id="demo-foo-filteringkategoriveb" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                ...
                                <th data-hide="phone, tablet">Menu</th>
  					            ...
  					            <tbody>
                          <?php
                          foreach( $tampilKatSaksi->result() as $kat ){ ?>
  					                <tr>
                ...
                <div class="modal-dialog ">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                              ...
                              <a class="btn btn-danger btn-rounded" href="<?php echo base_url('admin/Kategori_saksi/Hapus/'. $kat->id) ?>">Hapus Kategori</a>
                          </div>
                  </div>
                </div>
              </div>
...
<!-- Start Modal Edit -->
<?php echo form_open_multipart('admin/Kategori_saksi/Edit'); ?>
...
<!-- Start Modal Tambah -->
<?php echo form_open_multipart('admin/Kategori_saksi/Tambah'); ?>
...
<div class="modal-content">
   ...
   <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal"><i class="pci-cross pci-circle"></i></button>
       <h4 class="modal-title">Tambah Kategori Saksi</h4>
   </div>
